...
import numpy as np
import Preprocess
import os  # Thư viện để làm việc với các tệp tin và thư mục
...
# Tạo thư mục lưu trữ hình ảnh chụp nếu chưa có
    ...
    if detected == 1:
        ...
        for screenCnt in screenCnt:
            ...
            if len(char_x) in range(7, 10):
                ...
                plate_filename = f"{output_dir}/plate_{biensotimthay + 1}.jpg"
